...
function ze () {
    ...
    let pista = function (cavalos){ 
        ...
        //logica do podio. Parece me inutil e nao esta a resultar mas para testes acrescentar a condicao de paragem podio < 3 ||
        
        for (let indice = 0; indice < campeoes.length; indice++){
            
            //console.log('teeeeste', campeoes[indice].fasterthan);
            
            if (campeoes[indice].fasterthan.size > 21){
                
                podio.add(campeoes[indice])
    ...
    while ( /*podio.size < 3 ||*/ campeoes.length > 3 ) {
